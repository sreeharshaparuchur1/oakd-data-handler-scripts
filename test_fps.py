...
# print(f"Calib data: {device.readCalibration2()}  \n lens position {lensPosition}")
...
# print(dir(device.readCalibration2())) # 'eepromToJson', 'eepromToJsonFile', 'fromJson', 'getBaselineDistance', 'getCameraExtrinsics', 'getCameraIntrinsics', 'getCameraToImuExtrinsics', 'getCameraTranslationVector', 'getDefaultIntrinsics', 'getDistortionCoefficients', 'getEepromData', 'getFov', 'getImuToCameraExtrinsics', 'getLensPosition', 'getStereoLeftCameraId', 'getStereoLeftRectificationRotation', 'getStereoRightCameraId', 'getStereoRightRectificationRotation', 'setBoardInfo', 'setCameraExtrinsics', 'setCameraIntrinsics', 'setCameraType', 'setDistortionCoefficients', 'setFov', 'setImuExtrinsics', 'setLensPosition', 'setProductName', 'setStereoLeft', 'setStereoRight']
# print(f"Device intrinsics: {device.readCalibration2.getCameraIntrinsics()}")
# print(f"Device calib properties: {device.readCalibration2().getCameraIntrinsics(dai.CameraBoardSocket.RGB)}") # [[3082.245849609375, 0.0, 1908.54150390625], [0.0, 3082.245849609375, 1122.9630126953125], [0.0, 0.0, 1.0]]
...
with device:
    ...
    while True:
        ...
        #     frameDepth = latestPacket["depth"].getCvFrame()
            # cv2.imshow(rgbWindowName, frameDepth)
